...
const Loader = ({ onComplete }) => {
  ...
  return (
    <div
      ref={loaderRef}
      className="fixed w-full h-full inset-0 bg-[#ebf8ff] z-[9999] flex items-center justify-center overflow-hidden"
    >
      {/* Content center box */}
      <div
        ref={contentRef}
      ...
      >
        <FiFeather className="text-[var(--text)] text-5xl mb-4 animate-pulse" />
        <h1
          ref={textRef}
